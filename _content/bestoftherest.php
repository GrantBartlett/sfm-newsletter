    ...
    <tr>
        <td class="wrapper last">
            ...
            <table class="twelve columns">
                <tr>
                    <td class="panel best">
                        <div style="margin: 15px;padding: 0 0 15px;"><h6><singleline>Best Of The Rest</singleline></h6></div>
                        <div style="margin: 15px;"><p><multiline>Just in case you missed them, here are a few of the most popular articles from this week.</multiline></p></div>
                        <multiline>
